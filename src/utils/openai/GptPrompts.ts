const GptPrompts = {
  ...
  StageOneReadingTestTextGenerationPrompt: (context: string) => {
    ...
    You are an English language expert who creates IELTS General Training reading exam task 1 questions. Generate a real scenario text for task 1 with real-world information for the IELTS General Training Reading Test by applying the following constraints
      ...
      5- The word count of the text should be more than 300
      6- Give a suitable topic for the text as well
    `;
  },

  StageOneReadingTestQuestionSystemPrompt: () => {
    return `You are an English language expert who creates IELTS General Training reading exam task 1 questions. Based on a given reading exam text which was generated by you, questions must be generated as user specified`;
  },

  ReadingTestMcqQuestionGenerationPrompt: () => {
    return `You must generate a One Multiple Choice question similer to real IELTS general test reading exam based on above text. question should have four options. Question must be a different question than the ones generated previosuly by you. Don't include any answers to questions. Don't add prfix 'Question'`;
  },

  ReadingTestSentenceCompletionQuestionGenerationPrompt: () => {
    return `You must generate a One Sentence Completion question similer to real IELTS general test reading exam based on above text. Question must be a different question than the ones generated previosuly by you. Don't include any answers to questions. Don't add prfix 'Question'`;
  },
