...
readingTestRoute.get("/:readingTestId/stages", CognitoAuthMiddleware, readingTestController.getNextAvailablReadingTestStages.bind(readingTestController));
...
readingTestRoute.post("/:readingTestId/stages/:stageId/questions", CognitoAuthMiddleware, readingTestController.createReadingTestStageQuestions.bind(readingTestController));
